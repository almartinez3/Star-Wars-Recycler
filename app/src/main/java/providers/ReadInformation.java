...
public class ReadInformation {
    ...
    public ArrayList<Band> getAllBandsInTown () {
       // Band(String bandName, String bandGenre, String bandDescription, int bandMusicNumber)
        ...
        Band sexpistols = new Band ("Sex Pistols", "Post-grunge", "The Offspring es una banda de punk rock estadounidense, formada en Huntington Beach, California, en 1984 bajo el nombre de Manic Subsidal.", 4);
